...
REQUEST_COUNT = Counter('http_requests_total', 'Total HTTP Requests') # Total requests yang diterima
REQUEST_LATENCY = Histogram('http_request_duration_seconds', 'HTTP requests Latency') # Waktu respons API
MODEL_INFERENCE_COUNT = Counter('http_requests_throughput', 'Total number of requests per second') # Throughput model
...
def model_api():
    ...
    api_url = "http://127.0.0.1:5005/predictinvocation" # Sesuaikan dengan URL API model yang digunakan
